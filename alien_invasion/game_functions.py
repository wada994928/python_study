...
def write_high_score(stats):
    with open(stats.high_score_file_name, 'r') as file_object_read:
        high_score_last =  file_object_read.read()
        file_object_read.close()
        if not high_score_last or (high_score_last and int(high_score_last) < stats.high_score):
            with open(stats.high_score_file_name, 'w') as file_object_write:
                file_object_write.wirte(str(stats.high_score))
